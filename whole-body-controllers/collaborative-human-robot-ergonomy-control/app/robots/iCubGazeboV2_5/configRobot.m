...
WBTConfigRobot.UrdfFile  = 'iCubGazeboV2_5/model.urdf';
...
%% -- Gains --
% postural
ConfigRobot.Gains.GainPostural.Kp = diag([150    40   120,                       ...    % torso
                                          150    20    20    320,                ...    % left arm
                                          150    20    20    320,                ...    % right arm
                                          150    20    20    180   140    20,    ...    % left leg
                                          150    20    20    180   140    20]) * 0.5;   % right leg

ConfigRobot.Gains.GainPostural.Kd = 2 * ((ConfigRobot.Gains.GainPostural.Kp).^(1/2)) / 50;
...
jointPosUp_75 = [-0.15776           0           0 ...
                 ...
                 -0.5776     0.42622    -0.20011      1.1743 ...
                  0.072213    0.087084   0.0088584   -0.087318   -0.042648   -0.087617 ...
                  0.0722    0.087245   0.0089168   -0.087316   -0.042653   -0.087621];
...
ConfigRobot.StateMachine.controlledLinksKp = [7; 7; 7];
