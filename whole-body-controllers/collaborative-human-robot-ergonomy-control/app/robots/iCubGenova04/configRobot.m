...
ConfigRobot.Gains.GainPostural.Kp = diag([300   130   130,                       ...    % torso
                                          ...
                                          300    80    20    300   200    20]) * 3.0;   % right leg
...
ConfigRobot.StateMachine.tEnd = [4; 10; inf];
...
ConfigRobot.StateMachine.controlledLinksKp = [30; 30; 30] * 0.1;
