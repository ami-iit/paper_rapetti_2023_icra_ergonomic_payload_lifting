...
%% -- Gains --
% postural
ConfigRobot.Gains.GainPostural.Kp = diag([60    60,                              ...    % torso
                                          130    80    20     120,                ...    % left arm
                                          130    80    20     120,                ...    % right arm
                                          150    20    20    180   140    20,    ...    % left leg
                                          150    20    20    180   140    20]) * 3.5;   % right leg
...
ConfigRobot.Gains.GainMomentum.Kp = [50; 50; 300; 0.25; 0.25; 0.25];
...
ConfigRobot.StateMachine.tEnd = [3; 3; inf]; 
...
mass = 0;
% ConfigRobot.wrench_beq_const = [0; 20; (mass/2) * -9.81; zeros(3,1); 0; -20; (mass/2) * -9.81; zeros(3,1);];
ConfigRobot.wrench_beq_const = [0; 20; (mass/2) * -9.81; zeros(3,1); -20; -0; (mass/2) * -9.81; zeros(3,1);];
