...
WBTConfigRobot.UrdfFile  = 'iCubGenova02/model.urdf';
...
%% -- Gains --
% postural
ConfigRobot.Gains.GainPostural.Kp = diag([200   130   130,                       ...    % torso
                                          130    20    20     60,                ...    % left arm
                                          130    20    20     60,                ...    % right arm
                                          150    80    20    200   140    20,    ...    % left leg
                                          150    80    20    200   140    20]) * 2.5;   % right leg
